...
export const en = {
  ...
  evo_level: "Level up at Lv. {n} or above",
  evo_trade: "Trade this Pokémon",
  evo_trade_item: "Trade while holding {item}",
  evo_item: "Use {item}",
  evo_attack_higher: "Level up at Lv. {n}+ with Attack > Defense",
  evo_attack_equal: "Level up at Lv. {n}+ with Attack = Defense",
  evo_defense_higher: "Level up at Lv. {n}+ with Attack < Defense",
  evo_personality: "Level up at Lv. {n}+; branch depends on the individual",
  evo_shedinja:
    "At Lv. {n} evolution, also requires a free party slot and a Poké Ball",
  evo_beauty: "Level up with Beauty at least {n}",
  evo_female_level: "Female: level up at Lv. {n}+",
  evo_male_level: "Male: level up at Lv. {n}+",
  evo_night_level: "Level up at night at Lv. {n}+",
  evo_day_level: "Level up during the day at Lv. {n}+",
  evo_dusk_level: "Level up at dusk at Lv. {n}+",
  evo_held_day: "Level up during the day while holding {item}",
  evo_held_night: "Level up at night while holding {item}",
  evo_move: "Level up knowing {move}",
  evo_move_type: "Level up knowing a {type}-type move",
  evo_region: "Level up in {region}",
  evo_male_item: "Male: use {item}",
  evo_female_item: "Female: use {item}",
  evo_rain_level: "Level up in rain at Lv. {n}+",
  evo_party_species: "Level up with {species} in the party",
  evo_party_dark: "Level up at Lv. {n}+ with a Dark-type Pokémon in the party",
  evo_trade_species: "Trade for {species}",
  evo_map: "Level up on the required map (location unresolved)",
  ...
  abilityChoice:
    "Randomly selected when the team is generated; one ability per Pokémon",
  moveCategory: "Move category",
  moveEffectText: "Move effect",
  encounterVariant: "Story-dependent encounter set",
  encounterDefault: "Default encounter set",
  ...
  growth: "Growth curve",
  growth_0: "Medium fast",
  growth_1: "Erratic",
  growth_2: "Fluctuating",
  growth_3: "Medium slow",
  growth_4: "Fast",
  growth_5: "Slow",
  ability1: "Ability 1",
  ability2: "Ability 2",
...
export const zh: Record<Key, string> = {
  ...
  evo_level: "达到 {n} 级时升级进化",
  evo_trade: "通信交换进化",
  evo_trade_item: "携带「{item}」通信交换",
  evo_item: "使用「{item}」",
  evo_attack_higher: "{n} 级起升级，攻击高于防御",
  evo_attack_equal: "{n} 级起升级，攻击等于防御",
  evo_defense_higher: "{n} 级起升级，攻击低于防御",
  evo_personality: "{n} 级起升级；分支由个体的先天数据决定",
  evo_shedinja: "{n} 级进化时，同行需有空位，背包需有普通精灵球",
  evo_beauty: "美丽度达到 {n} 时升级",
  evo_female_level: "雌性，{n} 级起升级",
  evo_male_level: "雄性，{n} 级起升级",
  evo_night_level: "夜晚，{n} 级起升级",
  evo_day_level: "白天，{n} 级起升级",
  evo_dusk_level: "黄昏，{n} 级起升级",
  evo_held_day: "白天携带「{item}」升级",
  evo_held_night: "夜晚携带「{item}」升级",
  evo_move: "学会「{move}」后升级",
  evo_move_type: "学会{type}属性招式后升级",
  evo_region: "在「{region}」升级",
  evo_male_item: "雄性，使用「{item}」",
  evo_female_item: "雌性，使用「{item}」",
  evo_rain_level: "下雨时，{n} 级起升级",
  evo_party_species: "同行中有「{species}」时升级",
  evo_party_dark: "同行中有恶属性宝可梦，{n} 级起升级",
  evo_trade_species: "与「{species}」通信交换",
  evo_map: "在指定地图升级（具体地点待核实）",
  evo_unknown: "进化条件尚未核实，原始数据见开发者证据",
  unknownItem: "尚未识别的道具",
  unknownMove: "尚未识别的招式",
  abilityFixed: "固定特性",
  abilityChoice: "生成队伍时随机选择其一，每只只拥有一个特性",
  moveCategory: "招式分类",
  moveEffectText: "招式效果",
  encounterVariant: "随剧情变化的相遇方案",
  encounterDefault: "默认相遇方案",
