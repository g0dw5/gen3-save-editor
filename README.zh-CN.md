...
**当前为开发预览。** 漆黑的魅影 BW / DP 支持修改；火箭队 2.1 汉化版已接入只读预览。测试与尚未完成的项目见
...
| 西班牙火箭队 2.1 汉化版 · 只读 | `59c658a1081f542086de1060bb65f0b3` | 33,554,432 |
...
以下修改功能适用于漆黑的魅影 BW / DP。火箭队现可只读查看同行、盒子、道具及
ROM 资料，包含升级招式与 Mega／原始回归关系；地图、图鉴进度和写入暂未开放。
见[多 ROM 框架、验证范围与扩展流程](docs/multi-rom-adapters.md)。
