...
def main():
    ...
    with sync_playwright() as p:
        ...
        ivs.nth(1).fill('30')
        ivs.nth(2).fill('30')
        expect(summary).to_contain_text('Type 15')
        tabs.get_by_role('button', name='Moves', exact=True).click()
        expect(summary).to_contain_text('Type 15')
        expect(page.get_by_role('combobox', name='Move 1', exact=True)).to_have_value('【Spec.】【Type 15】【70】觉醒力量 #237')
        ...
        expect(summary.locator('.type-tag')).to_have_text('Type 15')
